...
export default function WordsBoard() {
	...
	return (
		<div
			className={`relative flex justify-center items-center py-[100px] px-[50px] w-full bg-no-repeat bg-cover bg-center text-[#17378D] font-bold text-[64px] ${forum.className} text-center z-0 w-full overflow-hidden`}
		>
			<div className="max-w-[1200px] flex flex-wrap justify-center items-center gap-[16px] md:gap-[100px]">
				{words.map((word) => (
					<motion.div
						initial={{
							opacity: 0,
