...
export default function Newsletter() {
	...
	return (
		<div
			...
			className={`relative gap-[100px] flex justify-center items-center py-[100px] px-[16px] md:px-[50px] w-full bg-no-repeat bg-cover bg-center text-[#17378D] font-bold text-[48px] ${forum.className} z-0 w-full overflow-hidden`}
		>
			<div className="flex flex-col md:flex-row max-w-[1200px] w-full">
				<div className="flex flex-col gap-[48px] md:w-[70%]">
					...
					>
						...
						early.
						<br />
						Just that you’ll find out once you join the waitlist. In
						an email. 😛
					</motion.div>
				...
				<img
					src="/images/gold-ticket.png"
					alt="Golden ticket"
					className="w-[100%] md:w-[40%] max-w-[650px] origin-center rotate-[-70deg]"
				/>
			</div>
		</div>
	);
