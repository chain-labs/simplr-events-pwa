		...
		<>
			...
			<div className="flex items-center justify-center md:h-screen md:overflow-hidden overflow-x-hidden my-10 md:my-0">
				<motion.div
					...
					animate="visible"
				>
					<div className="flex flex-col w-[98vw] justify-center items-center gap-[32px] px-[16px]">
						<motion.div
						...
						<div className="flex flex-col justify-center items-center gap-[8px]">
							...
							<motion.p
								className={`text-white text-[16px] ${dmSans.className}`}
								variants={itemVariants}
							>
								Life rarely gives do-overs, but hey, we&apos;re
								feeling generous.
								<br />
								Missed those Coldplay tickets? There&apos;s
								always someone selling an extra ticket.
								<br />
